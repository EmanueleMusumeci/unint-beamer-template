...
\title{UNINT Beamer Presentation Theme}
...
This template is a based on \hrefcol{https://www.overleaf.com/latex/templates/unint-presentation/jhbhdffczpnx}{UNINT Presentation} from \hrefcol{mailto:federico.zenith@unint.no}{Federico Zenith} and its derivation \hrefcol{https://github.com/TOB-KNPOB/Beamer-LaTeX-Themes}{Beamer-LaTeX-Themes} from Liu Qilong

\vspace{\baselineskip}

In the following you find a brief introduction on how to use \LaTeX\ and the beamer package to prepare slides, based on the one written by \hrefcol{mailto:federico.zenith@unint.no}{Federico Zenith} for \hrefcol{https://www.overleaf.com/latex/templates/unint-presentation/jhbhdffczpnx}{UNINT Presentation}
...
\begin{frame}{Beamer for UNINT slides}
\begin{itemize}
...
\framesubtitle{Selecting the UNINT Theme}
To start working with \texttt{unintbeamer}, start a \LaTeX\ document with the
preamble:
\begin{block}{Minimum UNINT Beamer Document}
...
\verb|\footlinecolor{color}|
      ...
      \testcolor{maincolor}, \testcolor{unintyellow}, 
      \testcolor{unintgreen}, \testcolor{unintdarkgreen}
...
\begin{colorblock}[black]{unintlightgreen}{Colour Blocks}
...
\small
\begin{verbatim}
\begin{colorblock}[black]{unintlightgreen}{title}
content...
\end{colorblock}
\end{verbatim}
\end{colorblock}
The ``official'' colours of colour blocks are: \testcolor{unintlilla}, 
\testcolor{maincolor}, \testcolor{unintdarkgreen}, and 
\testcolor{unintyellow}.
\end{column}
\end{columns}
\end{frame}
...
\begin{itemize}[<alert@2>]
  ...
  \item The colours are defined in the \texttt{unintcolor} package:
  \begin{itemize}
  \item Primary colours: \testcolor{maincolor} and its sidekick 
  \testcolor{unintgrey}
  \item Three shades of green: \testcolor{unintlightgreen}, 
  \testcolor{unintgreen}, \testcolor{unintdarkgreen}
  \item Additional colours: \testcolor{unintyellow}, \testcolor{unintred}, 
        \testcolor{unintlilla}
        \begin{itemize}
        \item These may be shaded---see the \verb|unintcolor| documentation or 
        the \hrefcol{https://unint.sharepoint.com/sites/stottetjenester/%
        kommunikasjon/grafisk-profil-new/Sider/default.aspx}{UNINT profile 
        manual}
        \end{itemize}
  \end{itemize}
...
\testcolor{unintdarkgreen}, \testcolor{unintgreen}, 
\testcolor{unintlightgreen}, \testcolor{unintred}, \testcolor{unintyellow}, 
\testcolor{unintlilla}.
      \begin{itemize}
...
\item If you have any suggestions or corrections, feel free to contribute to the \hrefcol{https://github.com/EmanueleMusumeci/unint-beamer-template}{GitHub repository}!
You can \hrefcol{https://github.com/EmanueleMusumeci/unint-beamer-template/issues/new/choose}{open an issue} or \hrefcol{https://github.com/EmanueleMusumeci/unint-beamer-template/fork}{fork the project} and directly propose your changes with a Pull Request. 
\end{itemize}
\end{frame}
